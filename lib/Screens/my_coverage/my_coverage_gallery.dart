...
class MyCoverageGallery extends StatefulWidget {
  const MyCoverageGallery({Key? key,required this.journeyResponseListItemDetails}) : super(key: key);
...
class _MyCoverageGalleryState extends State<MyCoverageGallery> {
  ...
  getStoreImageList() {
    ...
    HTTPManager().storeImagesList(UploadedImagesRequestModel(elId: userId,workingId: widget.journeyResponseListItemDetails.workingId.toString(),storeId: widget.journeyResponseListItemDetails.storeId.toString(),)).then((value) {
      setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: HeaderBackgroundNew(
        childWidgets: [
          const HeaderWidgetsNew(pageTitle: "My Coverage Gallery",isBackButton: true,isDrawerButton: true,),
          Expanded(
            child: Stack(
              children: [
  ...
  deleteImageFromStore(int index,StoreImageResponseItem storeImageResponseItem) {
    setState(() {
      isDeleteLoading = true;
    });

    HTTPManager().storeImagesDelete(DeleteImageRequestModel(imageId: storeImageResponseItem.id.toString(),storeId:storeImageResponseItem.storeId.toString() ,elId: storeImageResponseItem.elId.toString(),workingId:storeImageResponseItem.workingId.toString() )).then((value) {
