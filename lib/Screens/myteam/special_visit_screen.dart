...
class _SpecialVisitScreenState extends State<SpecialVisitScreen> {
  ...
  List<SpecialVisitListItem> specialVisitSearchList = <SpecialVisitListItem>[];
            ...
            onPressed: () {
              ...
              Navigator.of(context)
                  .push(MaterialPageRoute(
                      builder: (context) => const AddSpecialVisitScreen()))
                  .then((value) {
                                ...
                                : specialVisitList.isEmpty
                                    ? Center(
                                        child: Container(
                                            ...
                                            child: const Text(
                                                "No Special visit found")),
                                      )
                                    : searchController.text.isNotEmpty
                                        ? specialVisitSearchList.isEmpty
                                            ? const Center(
                                                child: Text(
  ...
  deleteSpecialVisit(int index, SpecialVisitListItem specialVisitListItem) {
    ...
    HTTPManager()
        .deleteSpecialVisit(DeleteSpecialVisitRequestModel(
            elId: userId, id: specialVisitListItem.id.toString()))
        .then((value) {
