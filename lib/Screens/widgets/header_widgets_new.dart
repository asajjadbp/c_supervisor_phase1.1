...
class HeaderWidgetsNew extends StatelessWidget {
  const HeaderWidgetsNew({Key? key,required this.pageTitle,required this.isBackButton,required this.isDrawerButton}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return  Column(
      children: [
        Container(
          margin: EdgeInsets.only(top: MediaQuery.of(context).size.height/17,left: 10,right: 10),
          child: Row(
            ...
            children: [
              Row(
                children: [
                  ...
                  InkWell(
                    onTap: () {
                      Navigator.of(context).push(MaterialPageRoute(builder: (context)=> const SettingScreenNew()));
                    },
                    child: SvgPicture.asset(
