        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              !isCheckedIn
                  ? Image.asset(
                      "assets/myicons/check_in_white_icon.png",
                      width: 23,
                      height: 23,
                    )
                  : Image.asset(
                      "assets/myicons/check_in_blue_icon.png",
                      width: 23,
                      height: 23,
                    ),
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              isCheckedIn
                  ? Image.asset(
                      "assets/myicons/check_out_white_icon.png",
                      width: 23,
                      height: 23,
                    )
                  : Image.asset(
                      "assets/myicons/check_out_blue_icon.png",
                      width: 23,
                      height: 23,
                    ),
              const SizedBox(width: 15),
