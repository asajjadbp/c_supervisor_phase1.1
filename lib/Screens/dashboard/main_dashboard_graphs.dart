...
import 'package:c_supervisor/Screens/dashboard/widgets/small_button_with_icon.dart';
...
class _DashboardGraphScreenState extends State<DashboardGraphScreen> {
  ...
  getDashboardData() {
    ...
    HTTPManager().dashboardDataDetails(JourneyPlanRequestModel(elId: userId)).then((value) {
      setState(() {
  ...
  Future<void> _getCurrentPosition(bool isAllow) async {
    ...
    await location.Geolocator.getCurrentPosition().then((location.Position position) async {
