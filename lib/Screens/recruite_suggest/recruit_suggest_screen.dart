...
class _RecruitSuggestScreenState extends State<RecruitSuggestScreen> {
          ...
          child: FloatingActionButton(
            ...
            onPressed: () {
              Navigator.of(context)
                  .push(
                MaterialPageRoute(
                  builder: (context) => AddRecruitSuggestScreen(
                    recruitSuggest: RecruitSuggest(),
                    isEdit: false,
                  ),
                ),
              )
                                                      ...
                                                      Navigator.of(context)
                                                          .push(
                                                              MaterialPageRoute(
                                                                  builder:
                                                                      (context) =>
                                                                          AddRecruitSuggestScreen(
                                                                            recruitSuggest:
                                                                                recruitSuggestList[index],
                                                                            isEdit:
                                                                                true,
                                                                          )))
                                                          .then((value) {
                                                        getRecruitSuggestList(
                                                            false);
                                                      });
                                                    },
                                                    child: Container(
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  Row(
                                                    children: [
                                                      Image.asset(
                                                        "assets/myicons/experience_icon.png",
                                                        width: 18,
                                                        height: 18,
                                                      ),
                                                      const SizedBox(
                                                      ...
                                                      Text(
                                                        "${recruitSuggestList[index].yearsOfExp!} years",
                                                        maxLines: 1,
                                                        overflow: TextOverflow
                                                            .ellipsis,
                                                        style: const TextStyle(
                                                ...
                                                children: [
                                                  ...
                                                  Expanded(
                                                      child: InkWell(
                                                          onTap: () {
                                                            String url =
                                                                "${LicenseProvider.imageBasePath}uploads/${recruitSuggestList[index].cv}";
                                                            print(url);
  ...
  deleteRecruitSuggest(int index, RecruitSuggest recruitSuggest) {
    ...
    HTTPManager()
        .deleteRecruitSuggest(DeleteRecruitSuggestRequestModel(
            elId: userId, id: recruitSuggestList[index].id.toString()))
        .then((value) {
